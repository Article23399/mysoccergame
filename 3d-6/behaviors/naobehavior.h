...
protected:
	...
	VecPosition getGKLocation();
    int getQiuYuan();
    int isOPHere(double angle,double r);
    int isTMHere(double angle,double r);
    int isPeopleHere(double angle,double r);
    VecPosition avoidGK();
    int isOPHere1(double angle,double r);
    int isTMHere1(double angle,double r);
    int isPeopleHere1(double angle,double r);
    VecPosition getSafePlace();
    int isFrontHere();
    SkillType kickOverMan(VecPosition dest);
     int getClosestMember();
	SkillType kickBallDire();
    VecPosition jieqiu();
    VecPosition theCloseOP();
    VecPosition theCloseTM();
